...
<head>
    ...
    <link rel="icon" href="/assets/icon/sihadeicon.png" type="image/x-icon">
...
<p class="margin-top:25px;"><br><br></p>
</div>
...
<h1 style="margin-top:10px; font-size: 16px; font-family: 'Lato', sans-serif; font-weight: 700;"> <i style="color:wheat" class="fas fa-seedling mr-2"></i><span style="color: wheat">Selamat Datang di Sihade !</span> </h1>
    <div class="container">
...
<form action="/login" method="post">
    ...
    {{-- <h5 class="margin-top:20px;">PT. Haznia Bina Virofarm</h5> --}}
    <div class="form-group mt-0">
        ...
        <input
            ...
            required
            value="{{ old('email') }}"
            style="margin-left: 330px; width: 400px; text-align: left; padding: 0 15px;"
        />
        @error('email')
    ...
    <div class="form-group mt-4 text-center" style="background-color: white;">
        ...
        <button type="submit" class="masuk" style="width: 300px; background-color: #FFCB0F; color: white; font-family: 'Lato', sans-serif; font-weight: 700;">
            <i class="fab fa-telegram" style="color: wheat; font-size: 16px; margin-right: 10px;"></i><span style="color: wheat"> Login</span>
        </button>
...
<button style="background-color: green; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">
    <h5 style="margin: 0; font-family: Lato', sans-serif" ><span style="color:wheat;">PT. Haznia Bina Virofarm</span></h>
</button>
