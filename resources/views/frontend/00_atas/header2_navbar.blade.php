...
{{--                  
        ...
        {{-- <a href="#">PROFIL</a> --}}
        <div class="dropdown">
            <a href="#" class="dropdown-toggle">DAFTAR AKUN</a>
            {{-- <i class="fas fa-chevron-down arrow"></i> --}}
            <div class="dropdown-content" style="min-width: 100px;">
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-user-plus" style="margin-left: 3px; margin-right: 8px; background: linear-gradient(90deg, black, yellow);"></i>
                    <a href="/registers" style="color: black; text-decoration: none; text-align:left">REGISTER</a>
                </div>
                
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-sign-in-alt" style="margin-left: 3px; margin-right: 8px; background: linear-gradient(90deg, black, yellow);"></i>
                    <a href="/login" style="color: black; text-decoration: none; text-align:left">LOGIN</a>
                </div>
