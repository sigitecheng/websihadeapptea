...
<div class="show-entries" style="border-radius: 10px;">
    <label for="entries" style="margin-right: 5px;">
        ...
        <button id="previewBtn" class="badge" style="border: none; font-size: 14px; cursor: pointer;">
            <i class="fas fa-info-circle mr-2"></i> Contact Us
        </button>
{{--         
...
<a href="/contactus/update/{{$item->id}}" style="background: inherit">
...
<style>
             ...
             <table>
                ...
                <thead>
                    @foreach ($data as $item)
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-map-marker-alt" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;">ALAMAT</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->alamat }}</th>
                    </tr>
                    
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-phone" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;">TELEPON 1</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->telepon1 }}</th>
                    </tr>
                    
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-phone" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;">TELEPON 2</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->telepon2 }}</th>
                    </tr>
                    
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-envelope" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;">EMAIL 1</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->email1 }}</th>
                    </tr>
                    
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-envelope" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;">EMAIL 2</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->email2 }}</th>
                    </tr>
                    
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-clock" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;">JAM KERJA MULAI</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->jamkerjamulai }} Pagi</th>
                    </tr>
                    
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-clock" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;">JAM KERJA SELESAI</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->jamkerjaselesai }} Sore</th>
                    </tr>
