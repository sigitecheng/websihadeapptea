...
<div class="show-entries" style="border-radius: 10px;">
    <label for="entries" style="margin-right: 5px;">
        ...
        <button id="previewBtn" class="badge" style="border: none; font-size: 14px; cursor: pointer;">
            <i class="fas fa-info-circle mr-2"></i>About Sihade
...
<a href="/aboutsihade/update/{{$item->id}}" style="background: inherit">
...
<style>
             ...
             <table>
                ...
                <thead>
                    @foreach ($data as $item)
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-info-circle" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>ABOUT SIHADE</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->judul }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-star" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>POINT 1</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->point1 }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-star" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>POINT 2</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->point2 }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-star" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>POINT 3</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->point3 }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-star" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>POINT 4</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->point4 }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-star" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>POINT 5</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->point5 }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-star" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>POINT 6</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->point6 }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-star" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>POINT 7</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->point7 }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-star" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>POINT 8</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->point8 }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-star" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>POINT 9</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->point9 }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-comments" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>KETERANGAN</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->keterangan }}</th>
                    </tr>
