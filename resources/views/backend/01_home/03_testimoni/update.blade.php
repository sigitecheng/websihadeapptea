...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge" style="font-size: 14px;"><i class="fas fa-pencil-alt mr-2"></i>Update Data Testimoni</div>
        </a>
        <a style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            @endif
            <form action="{{ route('update.datatestimoni', $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase;" type="text" class="form-control" id="namalengkap" name="namalengkap" value="{{ old('namalengkap', $data->namalengkap) }}" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <textarea style="text-transform: uppercase;" class="form-control" id="komentar" name="komentar" required>{{ old('komentar', $data->komentar) }}</textarea>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase;" type="text" class="form-control" id="jabatan" name="jabatan" value="{{ old('jabatan', $data->jabatan) }}" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase;" type="text" class="form-control" id="perusahaan" name="perusahaan" value="{{ old('perusahaan', $data->perusahaan) }}" required>
                </div>
