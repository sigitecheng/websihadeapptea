...
<a href="/FAQ/update/{{$item->id}}" style="background: inherit">
...
<style>
             ...
             <table>
                ...
                <thead>
                    ...
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-question-circle" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>PERTANYAAN 5</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->pertanyaan5 }}</th>
                    </tr>
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;"><i class="fas fa-comment-dots" style="color: white;"></i></th>
                        <th style="width:125px; font-size:12px; text-align:left;"><i></i>JAWABAN 5</th>
                        <th style="width:25px; font-size:12px;"><i class="fas fa-arrow-right" style="color: black;"></i></th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">{{ $item->jawaban5 }}</th>
                    </tr>
