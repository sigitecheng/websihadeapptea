...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge" style="font-size: 14px;"><i class="fas fa-pencil-alt mr-2"></i>Create Data Partners</div>
        </a>
        <a style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('create.datapartners') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    <label for="alamatperusahaan" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                        <i class="fas fa-briefcase mr-2"></i> Alamat Perusahaan
                    </label>
                    <input style="text-transform: uppercase;" type="text" class="form-control" id="alamatperusahaan" name="alamatperusahaan" value="{{ old('alamatperusahaan') }}" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase; display: none;" type="file" class="form-control" id="gambarperusahaan" name="gambarperusahaan" accept="image/*" required>
                    <img id="gambarperusahaan_preview" src="{{ asset('default-image.png') }}" alt="Preview" style="width: 200px; height: auto;"/>
                </div>
