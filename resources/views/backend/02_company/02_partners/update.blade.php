...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge" style="font-size: 14px;"><i class="fas fa-pencil-alt mr-2"></i>Update Data Partners</div>
        </a>
        <a style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('update.datapartners', $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    <label for="alamatperusahaan" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                        <i class="fas fa-map-marker-alt mr-2"></i> Alamat Perusahaan
                    </label>
                    <textarea style="text-transform: uppercase;" class="form-control" id="alamatperusahaan" name="alamatperusahaan" required>{{ old('alamatperusahaan', $data->alamatperusahaan) }}</textarea>
                </div>
                
                <div class="form-group d-flex align-items-center mt-3">
                    <label for="gambarperusahaan" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                        <i class="fas fa-image mr-2"></i> Upload Foto Perusahaan
                    </label>
                    <button type="button" class="btn btn-success mr-3" onclick="document.getElementById('gambarperusahaan').click();">
                        <i class="fas fa-upload mr-2"></i> Upload Foto
                    </button>
                    <input style="text-transform: uppercase; display: none;" type="file" class="form-control" id="gambarperusahaan" name="gambarperusahaan" accept="image/*">
                    <img id="gambarperusahaan_preview" src="{{ asset('storage/' . $data->gambarperusahaan) }}" alt="Preview" style="width: 200px; height: auto;"/>
                </div>
                
                
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        const fileInput = document.getElementById('gambarperusahaan');
                        const preview = document.getElementById('gambarperusahaan_preview');
