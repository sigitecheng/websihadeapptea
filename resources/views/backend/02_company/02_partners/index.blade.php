    ...
    <label for="entries" style="margin-right: 5px;">
        ...
        .badge-plus:hover {
         ...
         <button id="previewBtn" class="badge" style="border: none; font-size: 14px; cursor: pointer;">
            <i class="fas fa-users mr-2"></i>Data Partners Sihade
        ...
        <a href="/partnerscreate" style="background: inherit">
             ...
             <table>
                <thead>
                    <tr>
                        ...
                        <th style="width:200px; font-size:12px;">ALAMAT</th>
                        <th style="width:200px; font-size:12px;">LAMBANG PERUSAHAAN</th>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;">{{ $item->alamatperusahaan}}</td>
                        <td style="font-size: 12px; text-align:center;">
                            <img style="width: 50%;" src="{{asset('storage/' . $item->gambarperusahaan)}}" alt="">
                        </td>
                    ...
                    .iconhover i {
                        ...
                        {{-- <a href="/pengawasandanketertiban/{{$item->judul}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                                ...
                                <a href="/partners/update/{{$item->id}}" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.datapartners', $item->id) }}')">
