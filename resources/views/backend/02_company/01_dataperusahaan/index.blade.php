    ...
    <label for="entries" style="margin-right: 5px;">
        ...
        .badge-plus:hover {
         ...
         <button id="previewBtn" class="badge" style="border: none; font-size: 14px; cursor: pointer;">
            ...
            <i class="fas fa-building mr-2"></i> Data Company
        ...
        <a href="/companycreate" style="background: inherit">
             ...
             <table>
                <thead>
                    <tr>
                        ...
                        {{-- <th>Judul</th> --}}
                        <th style="width:200px; font-size:12px;">PERUSAHAAN</th>
                        <th style="width:75px; font-size:12px;">KOTA</th>
                        <th style="width:125px; font-size:12px;">PROVINSI</th>
                        <th style="width:75px; font-size:12px;">NEGARA</th>
                        <th style="width:200px; font-size:12px;">RUANG PRODUKSI</th>
                        <th style="width:200px; font-size:12px;">KARYAWAN</th>
                        <th style="width:75px; font-size:12px;">KAPASITAS</th>
                        <th style="width:140px; font-size:12px;">KETERANGAN</th>
                        <th style="width:75px; font-size:12px;">KUALITAS</th>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;">{{ $item->namaperusahaan}}</td>
                        <td style="font-size: 12px; text-align:center;">{{ $item->kota}}</td>
                        <td style="font-size: 12px; text-align:center;">{{ $item->provinsi}}</td>
                        <td style="font-size: 12px; text-align:center;">{{ $item->negara}}</td>
                        <td style="font-size: 12px; text-align:center;">{{ $item->namaruangproduksi}}</td>
                        <td style="font-size: 12px; text-align:center;">{{ $item->jumlahkaryawan}}</td>
                        <td style="font-size: 12px; text-align:center;">{{ $item->kapasitasproduksi}}</td>
                        <td style="font-size: 12px; text-align:center;">{{ $item->keteranganperalatan}}</td>
                        <td style="font-size: 12px; text-align:center;">{{ $item->kualitas}}</td>
                    ...
                    .iconhover i {
                        ...
                        {{-- <a href="/pengawasandanketertiban/{{$item->judul}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                                ...
                                <a href="/company/update/{{$item->id}}" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.datacompany', $item->id) }}')">
