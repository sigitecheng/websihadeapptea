...
<div class="show-entries" style="border-radius: 10px;">
    <label for="entries" style="margin-right: 5px;">
        ...
        <button id="previewBtn" class="badge" style="border: none; font-size: 14px; cursor: pointer;">
            <i class="fas fa-archive mr-2"></i> Berkas Sihade
...
<a href="/berkassihade/update/{{$item->id}}" style="background: inherit">
...
<style>
             ...
             <table>
                ...
                <thead>
                    ...
                    <tr>
                        <th style="width:25px; background:green; font-size:12px;">
                            <i class="fas fa-file-alt" style="color: white;"></i>
                        </th>
                        <th style="width:125px; font-size:12px; text-align:left;">BROSUR</th>
                        <th style="width:25px; font-size:12px;">
                            <i class="fas fa-arrow-right" style="color: black;"></i>
                        </th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">
                            <!-- Tautan untuk mengunduh file -->
                            <a href="{{ asset('storage/' . $item->brosur) }}" target="_blank" style="color: white; text-decoration: none; border-radius:10px;">
                               <span style="font-size: 14px;"> Lihat Brosur</span>
                            </a>
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th style="width:125px; font-size:12px; text-align:left;">DAFTAR MERK</th>
                        <th style="width:25px; font-size:12px;">
                            <i class="fas fa-arrow-right" style="color: black;"></i>
                        </th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">
                            <!-- Tautan untuk mengunduh file -->
                            <a href="{{ asset('storage/' . $item->daftarmerk) }}" target="_blank" style="color: white; text-decoration: none; border-radius:10px;">
                                <span style="font-size: 14px;"> Lihat Daftar Merk</span>
                            </a>
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th style="width:125px; font-size:12px; text-align:left;">NIB</th>
                        <th style="width:25px; font-size:12px;">
                            <i class="fas fa-arrow-right" style="color: black;"></i>
                        </th>
                        ...
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">
                            <!-- Tautan untuk mengunduh file -->
                            <a href="{{ asset('storage/' . $item->nib) }}" target="_blank" style="color: white; text-decoration: none; border-radius:10px;">
                                <span style="font-size: 14px;"> Lihat NIB</span>
                            </a>
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th style="width:125px; font-size:12px; text-align:left;">SURAT SIHADE</th>
                        <th style="width:25px; font-size:12px;">
                            <i class="fas fa-arrow-right" style="color: black;"></i>
                        </th>
                        <th style="background:white; width:500px; font-size:12px; text-align:left;">
                            <!-- Tautan untuk mengunduh file -->
                            <a href="{{ asset('storage/' . $item->suratsihade) }}" target="_blank" style="color: white; text-decoration: none; border-radius:10px;">
                                <span style="font-size: 14px;"> Lihat Surat Sihade</span>
                            </a>
                        </th>
                    </tr>
