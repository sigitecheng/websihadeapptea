...
{{--                 
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <div class="input-group">
                        ...
                        <input style="text-transform: uppercase;" type="number" class="form-control" id="hargasatuan" name="hargasatuan" value="{{ old('hargasatuan', $data->hargasatuan) }}" required>
                    </div>
                </div>
                ...
                <script>
                    ...
                    function hitungTotalHarga() {
                        ...
                        if (kuantiti && hargasatuan) {
                            var totalHarga = parseFloat(kuantiti) * parseFloat(hargasatuan);
                    ...
                    // Pastikan inputan harga satuan tetap dalam format Rupiah
                    document.getElementById('hargasatuan').addEventListener('input', function(e) {
                        var inputValue = e.target.value;
                        var formattedValue = removeRupiah(inputValue);
                        e.target.value = formatRupiah(formattedValue);
                    });
