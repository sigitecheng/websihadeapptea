...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge" style="font-size: 14px;"><i class="fas fa-pencil-alt mr-2"></i>Create Data Agriculture Product</div>
        </a>
        <a style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('create.dataproductagriculture') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
