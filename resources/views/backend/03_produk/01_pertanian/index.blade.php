    ...
    <label for="entries" style="margin-right: 5px;">
        ...
        .badge-plus:hover {
         ...
         <button id="previewBtn" class="badge" style="border: none; font-size: 14px; cursor: pointer;">
            <i class="fas fa-leaf mr-2"></i>Agriculture Products
        ...
        <a href="/bepertaniancreate" style="background: inherit">
             ...
             <table>
                <thead>
                    <tr>
                        ...
                        {{-- <th>Judul</th> --}}
                        <th style="width:125px; font-size:12px;">NAMA PRODUK</th>
                        {{-- <th style="width:200px; font-size:12px;">KOMENTAR</th> --}}
                        <th style="width:170px; font-size:12px;">GAMBAR PRODUK</th>
                        <th style="width:1000px; font-size:12px;">KETERANGAN</th>
                        <th style="width:200px; font-size:12px;">TANGGAL UPLOAD</th>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;">{{ $item->namaproduk}}</td>
                    ...
                    .iconhover i {
                        ...
                        {{-- <a href="/pengawasandanketertiban/{{$item->judul}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                                ...
                                <a href="/bepertanian/update/{{$item->id}}" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.databepertanian', $item->id) }}')">
