...
<body class="font-Noto-Sans">
  ...
  <!-- Header -->
  <header class="w-full bg-[url('/assets/icon/404.jpg')] bg-cover bg-bottom">  
    <div class="w-full min-h-screen md:w-1/2 bg-gradient-to-b from-gray-900/90 to-gray-900/95 p-10 flex">
      <div class="w-full text-center my-auto">
        ...
        <h6 class="font-Montserrat font-bold uppercase text-4xl md:text-5xl lg:text-3xl mb-14 md:-mr-20 text-white md:text-left">PT. HAZNIA BINA VIROFARM <br> SIHADE ORGANIC FARM<span class="text-white/70 md:-mr-20"></span></h6>
